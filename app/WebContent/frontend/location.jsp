...
<!--eventtyp: 15 Conversation-->
<div class="test easyui-panel" data-options="fit:true,border:false">
	<div class="bgimg">	
	<div class="description"></div>
	<div style="clear: both;"></div>
	...
	<div style="clear: both;"></div>
	<div class="buttonContainer">
		<div id="continueButtonMatrixTest" class="easyui-linkbutton allocationButton">Done</div>
	</div>
</div>
</div>
